...
from pynvr2.models.config.janitorpolicies.durationconfigmodel import DurationMaxConfigModel
...
def test(policy_value: int, current_date: str, record_segment_date: str, expected_policy_result: PolicyResult):
    ...
    policy_config = DurationMaxConfigModel(**{
        'name': DurationMaxConfigModel._NAME,
        'value': policy_value,
    })
